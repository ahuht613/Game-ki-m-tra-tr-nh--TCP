...
//            {3, "alicejohnson", "Alice Johnson", 78.5},
    ...
    private void invitePlayer() {
        ...
        if (selectedRow != -1) {
            ...
            JOptionPane.showMessageDialog(this, "Please choose a player to invite!", "No Player Selected", JOptionPane.WARNING_MESSAGE);
        }
    }
    ...
    public void updateUserList(Object[][] userData) {
        ...
        dataTable.setModel(new javax.swing.table.DefaultTableModel(
            userData,
            new String[]{"ID", "Username", "Full Name", "Score", "Status"}
        ));
    });
    }
